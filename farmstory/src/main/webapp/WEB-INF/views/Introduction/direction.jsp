        ...
        <div id="sub">
            ...
            <section class="introduction">
                <aside>
                    ...
                    <ul class="lnb">
                        <li><a href="${path}/introduction/hello.do">인사말</a></li>
                        <li class="on"><a href="${path}/introduction/direction.do">찾아오시는 길</a></li>
                    </ul>

                </aside>
                <article>
                    <nav>
                        <img src="${path}/images/sub_nav_tit_cate1_tit2.png" alt="찾아오시는길"/>
                        <p>
